...
def show_ai_doctor():
    ...
    if st.session_state.current_step < len(questions):
        ...
        # Add doctor question if not already added
...
def show_daily_reminder():
    ...
    if st.session_state.last_reminder != today:
        ...
        st.sidebar.markdown("<div class='reminder'>🔔 Daily Reminder: Please check your health with EpidemicCare AI today!</div>", unsafe_allow_html=True)
